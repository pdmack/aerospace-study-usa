...
- **Letters of recommendation:** Three, ideally from research supervisors. Obers and Holger Bech Nielsen at NBI are strong. Your CERN supervisor counts.
...
## Your profile — how to present it
...
**What to address:**
- No prior AE or engineering coursework — acknowledge it directly in the Statement of Purpose, then pivot to why your background is relevant to the specific sub-area you're targeting. "I come from a plasma physics background, which I believe is directly applicable to Hall thruster research" is more effective than silence on the gap.
...
- **arXiv and AIAA papers:** Read papers from the groups you're targeting. Understanding the language and open problems before you email faculty makes the email substantively better.
